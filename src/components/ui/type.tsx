...
export function Heading({ className, ...props }: ComponentProps<'h1'>) {
  return (
    <h1
      className={clsx('text-3xl/snug md:text-5xl/snug py-4 text-balance dark:text-white', adamina.className, className)}
      {...props}
    />
  )
}
...
export function TextLink({ className, ...props }: ComponentProps<typeof Link>) {
  return (
    <Link
      className={clsx(
        'font-medium underline text-blue-600 hover:text-blue-700 dark:text-blue-500 dark:hover:text-blue-400',
        className
      )}
      {...props}
    />
