export default function typographyStyles({ theme }: { theme: (variable: string) => any }) {
  return {
    DEFAULT: {
      css: {
        ...
        '--tw-prose-links-underline': theme('colors.blue.600'),
        ...
        '--tw-prose-invert-links-underline': theme('colors.blue.400'),
